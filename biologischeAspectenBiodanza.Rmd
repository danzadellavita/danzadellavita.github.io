...
date: "[Danza della Vida](https://danzadellavida.github.io) & [statOmics](https://statomics.github.io)"
output:
    html_document:
      code_download: true
      toc: true
...
Slides voor Weekend 4 "Biologische Aspecten van Biodanza" in de [Biodanza opleiding Antwerpen](https://www.biodanzaschoolantwerpen.be/biodanza-opleiding)
...
- Prigogine noemt leven daarom een dissipatieve structuur
...
Ontstaan van leven: eerst energie, dan chemie en daarna informatie. 
...
- Katalysator: een chemische verbinding die de reactie help plaatsvinden zonder hierbij te worden verbruikt. Biologische katalysatoren worden enzymes genoemd. 

- Enzymes zijn eiwitten

Enzymes 

- vissen de molecules het complex mengsel van de cell 
- die uit duizenden verbindingen bestaan
- meestal met een lage concentratie
- via bindingssites die de nodige moleculen, substraten, op die manier in 3D samen brengen 
- zodat deze kunnen reageren en een nieuwe verbinding kunnen vormen. 
...
- Code is zo geëvolueerd dat veel mutaties leiden tot synonieme codons  of tot inbouwen van aminozuur dat niet erg sterk verschillend is $\rightarrow$ eiwit functie blijft behouden
...
$\rightarrow$ zwarte kracht trekt wolk verder samen
...
wat een eerste stap is naar aminozuren (bouwblokken eiwitten) en nucleotiden (bouwblokken RNA en DNA). 

## Onstaan van het zonnestelsel en de genese van het leven
...
- Recombinatie: grote stukken DNA die van plaats worden gewisseld 
...
- Komt veelvuldig voor tussen prokaryoten (eubacteria en arachae) vb uitwisseling resistentie tegen antibiotica, maar ook in eukaryoten (protisten)
...
- 3.5 BYA - 520 MYA enkel prokaryote cellen 
...
Genetische informatie van een soort kan ook worden gezien als een record van de milieus en ontwikkeling die ze heeft ondergaan tot dit punt. 
...
- Elke cel bevat zelfde erfelijk materiaal!
...
- Het leven is een obligate manifestatie van materie die is geschreven in het weefsel van de kosmos (Christian de Duve)
    ...
    - In de sterren onstonden de atomen van het leven 
    ...
    - Eerst was er energie, toen kwam chemie en daarna informatie: het leven
