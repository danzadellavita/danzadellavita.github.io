...
### <span style="color:#AD441F"> Nieuw! </span>  Biodanza Driedaagse Identiteit & de Vier Elementen met Fien & Lieven - [<button type="attribute"> meer info</button>](./vierElementen.html)
<img src="./figs/uitnodigingVierElementen5.png" alt="drawing" width="100%"/>


<!--
### <span style="color:#AD441F"> Nieuw! </span>  Voordracht Eindwerk Lieven -- Biologische Aspecten van Biodanza op 02/03 - meer [info](./activiteiten.html#verdedigingLieven)
-->

</br>

Biodanza is het Leven Dansen.  
Het is jezelf en de ander ontmoeten.    
Het is Beweging voor je hele zijn.   

De kracht van muziek, dans en beweging in groep    
wekken een beleving (vivencia) op  
die door kan werken in je dagdagelijkse leven.    
...
<source src="./figs/IMG_2766.m4v" type="video/mp4" />
<track
    src="./figs/IMG_2766.m4v"
    label="NL"
    kind="captions"
    srclang="nl" 
    default />
...
<center>
![](./figs/logoBiodanza.png){width=30%}
</center>
